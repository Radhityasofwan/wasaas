...
// ============================================================================
router.get("/admin/tenants", async (req: any, res: any) => {
  try {
...
// ============================================================================
router.get("/admin/plans", async (req: any, res: any) => {
  try {
    const [rows] = await pool.query<any[]>(
...
// ============================================================================
router.put("/admin/tenants/:id/limits", async (req: any, res: any) => {
  try {
...
// ============================================================================
router.post("/admin/tenants", async (req: any, res: any) => {
