...
// ============================================================================
// Menggunakan multiple path (Array) agar kebal dari perbedaan pemanggilan Frontend
router.get(["/tenants", "/admin/tenants"], async (req: any, res: any) => {
  try {
...
// ============================================================================
router.get(["/plans", "/admin/plans"], async (req: any, res: any) => {
  try {
    const [rows] = await pool.query<any[]>(
...
// ============================================================================
router.put(["/tenants/:id/limits", "/admin/tenants/:id/limits"], async (req: any, res: any) => {
  try {
...
// ============================================================================
router.post(["/tenants", "/admin/tenants"], async (req: any, res: any) => {
