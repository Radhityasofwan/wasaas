...
// Fitur Cabut Akses (Soft Delete) - Kunci tidak dihapus, tapi tidak bisa dipakai
...
// Fitur Hapus Permanen (Hard Delete) - Kunci dihapus total dari database
export async function deleteApiKey(tenantId: number, id: number) {
  const [res] = await pool.query<any>(
