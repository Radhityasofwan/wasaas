...
// Import UI specific broadcast routes (List Jobs & Cancel) - Pindahkan ke atas sini
...
// --- FIX ROUTING: List Jobs HARUS DI ATAS Detail Job (:id) ---
app.get("/broadcast/jobs", apiKeyAuth, (req:any,res:any)=>listBroadcastJobs(req,res)); // <-- INI YANG BARU

// Routes Detail (Params :id)
