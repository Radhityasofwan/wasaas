  ...
  // ===== API KEYS (dashboard) =====
  // Menggunakan dashboardAuthMw agar UI lokal bisa membaca list tanpa error
  app.use(["/api-keys", "/-keys", "/keys"], dashboardAuthMw, apiKeysRoutes);
  ...
  // ===== TEXT =====
  // API Public endpoint sebaiknya tetap menggunakan apiKeyAuth jika diakses dari luar,
  // tapi kita berikan dashboardAuthMw untuk kemudahan testing dari chat UI web.
