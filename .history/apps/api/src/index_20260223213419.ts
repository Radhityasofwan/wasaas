...
import { deleteSessionRoute } from "./sessions_routes";
...
app.post("/sessions/delete", deleteSessionRoute);

app.post("/webhooks/set", dashboardAuthMw, (req: any, res: any) => setWebhook(req, res));
import { setWebhook, getWebhook } from "./webhook_routes"; // Pastikan import getWebhook
