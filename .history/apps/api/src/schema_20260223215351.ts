...
/* =========================================================
   WA SaaS - FULL SCHEMA (MySQL 8) - FIXED FOR INBOX STABLE
   Changes:
   - wa_messages: add user_id + UNIQUE (tenant_id,session_key,wa_message_id)
   - keep existing tables & seeds
   ========================================================= */
...
CREATE TABLE IF NOT EXISTS wa_messages (
  ...
  UNIQUE KEY uq_msg_waid (tenant_id, session_key, wa_message_id),
