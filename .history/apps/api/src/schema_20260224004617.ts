...
INSERT INTO plans (code, name, price_monthly, currency, limit_sessions, limit_messages_daily, limit_broadcast_daily, limit_contacts, is_active)
VALUES 
('starter', 'Paket Starter', 150000, 'IDR', 1, 500, 1, 1000, 1),
('pro', 'Paket Pro', 350000, 'IDR', 3, 2000, 5, 5000, 1),
('enterprise', 'Paket Enterprise', 950000, 'IDR', 10, 10000, 20, 50000, 1);
