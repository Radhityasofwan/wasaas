...
// --- MOCK IMPLEMENTATIONS FOR CANVAS PREVIEW ---
// In your actual local project, please replace these with your actual file imports:
...
const MockPage = ({ title }: { title: string }) => (
  <div className="w-full h-full min-h-[60vh] flex flex-col items-center justify-center bg-white/50 rounded-2xl border-2 border-slate-200 border-dashed">
    <div className="text-slate-400 font-bold text-2xl mb-2">{title}</div>
    <p className="text-slate-500 text-sm">This is a mock component for the preview.</p>
  </div>
);

const Login = () => <MockPage title="Login" />;
const Sessions = () => <MockPage title="Sessions" />;
const Inbox = () => <MockPage title="Inbox" />;
const Webhooks = () => <MockPage title="Webhooks" />;
const Broadcast = () => <MockPage title="Broadcast" />;
const Leads = () => <MockPage title="Leads" />;
const ApiKeys = () => <MockPage title="API Keys" />;
const AutoReply = () => <MockPage title="Auto Reply" />;
const Admin = () => <MockPage title="Admin" />;
const Docs = () => <MockPage title="API Docs" />;
const Templates = () => <MockPage title="Templates" />;
const AutoFollowUp = () => <MockPage title="Auto Follow Up" />;

const getApiKey = () => "mock-api-key";
const clearApiKey = () => console.log("Logged out");
// ------------------------------------------------

/**
 * Guard Component: Memastikan pengguna memiliki API Key.
 */
...
function Shell({ children }: { children: React.ReactNode }) {
  ...
  // Ambil 4 menu pertama untuk Bottom Navigation di Mobile
