...
function Shell({ children }: { children: React.ReactNode }) {
  ...
  // Kelompokkan menu berdasarkan group
  const groupedMenu = visibleMenu.reduce((acc, item) => {
  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full bg-white border-r border-slate-100 safe-area-pb">
      {/* Brand Logo - Gaya Minimalis */}
      ...
      {/* Navigation Links - Berkelompok & Pill Shape (Google Style) */}
      ...
      {/* User Profile & Logout - Bagian Bawah yang Lega */}
      <div className="p-4 shrink-0">
        <div className="bg-slate-50 rounded-2xl p-4 flex flex-col gap-3 border border-slate-100">
          ...
          <button
            ...
            className="w-full py-2.5 flex items-center justify-center gap-2 rounded-xl text-sm font-semibold text-slate-600 bg-white hover:bg-rose-50 hover:text-rose-600 border border-slate-200 transition-colors"
          >
