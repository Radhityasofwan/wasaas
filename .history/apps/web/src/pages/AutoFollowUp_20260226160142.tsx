                ...
                {group.campaigns.map((camp, cIdx) => {
                  ...
                  return (
                    <div 
                      ...
                      className={`relative z-10 p-3.5 flex flex-col gap-2 rounded-2xl cursor-pointer transition-colors border ${
                        isSelected 
                    ...
                    >
                      <div className="flex justify-between items-start">
                        ...
                        <span className={`px-2 py-0.5 rounded text-[9px] font-bold uppercase tracking-wider border shrink-0 ml-2 ${
