...
let mockRules = [
  { id: 1, keyword: "ping", match_type: "exact" as const, reply_text: "PONG! Sistem berjalan lancar 🤖", is_active: true },
  { id: 2, keyword: "harga", match_type: "contains" as const, reply_text: "Halo! Untuk informasi harga, Anda bisa mengunjungi website kami di domain.com/pricing.", is_active: true }
];
