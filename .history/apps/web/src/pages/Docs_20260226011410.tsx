  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 md:space-y-8 animate-in fade-in duration-500 pb-20">
      ...
      <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
        ...
        {/* CONTENT AREA (Kanan / Bawah) */}
        <div className="flex-1 bg-white border border-slate-100 rounded-3xl p-6 md:p-10 shadow-sm min-h-[500px]">
          ...
          {activeTab === "auth" && (
            <div className="space-y-8 animate-in slide-in-from-right-4 duration-300">
              <section className="space-y-4">
                ...
                <div className="bg-[#1f1f1f] rounded-2xl overflow-hidden border border-[#333] shadow-md mt-4">
                  ...
                  <pre className="p-5 text-xs md:text-sm font-mono text-slate-300 overflow-x-auto leading-loose">
                  ...
                  <div className="p-5 rounded-2xl bg-amber-50 border border-amber-100 flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-amber-600/90 font-medium leading-relaxed">
                        <code className="bg-white/60 px-1 rounded border border-amber-200 block mb-1 w-max">message_limit_reached</code>
              ...
              <section className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <code className="text-sm font-bold text-slate-600 bg-[#f0f4f9] px-2 py-0.5 rounded">/v1/messages/send-text</code>
                  </div>
                </div>
                ...
                <div className="bg-[#1f1f1f] rounded-2xl overflow-hidden border border-[#333] shadow-md">
                  ...
                  <pre className="p-5 text-xs md:text-sm font-mono text-[#82aaff] overflow-x-auto leading-loose">
{`{
  ...
  "text": "Halo! Ini pesan notifikasi dari sistem."
                  ...
                  <div className="bg-[#1a1a1a] p-4 border-t border-[#333]">
                    ...
                    <code className="text-xs font-mono text-[#c3e88d]">{`{ "ok": true, "messageId": "BAE5..." }`}</code>
                  </div>
                </div>
              </section>
              ...
              <section className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-3">
                    <span className="px-3 py-1 bg-emerald-50 text-emerald-600 text-[10px] font-bold uppercase tracking-wider rounded-md border border-emerald-200">POST</span>
                    <code className="text-sm font-bold text-slate-600 bg-[#f0f4f9] px-2 py-0.5 rounded">/v1/messages/send-media</code>
                  </div>
                </div>

                <div className="bg-[#1f1f1f] rounded-2xl overflow-hidden border border-[#333] shadow-md">
                  <pre className="p-5 text-xs md:text-sm font-mono text-[#c792ea] overflow-x-auto leading-loose">
{`{
  "sessionKey": "device-01",
  "to": "628123456789",
  ...
  "caption": "Berikut adalah tagihan Anda bulan ini."
              ...
              <section className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-3">
                    <span className="px-3 py-1 bg-emerald-50 text-emerald-600 text-[10px] font-bold uppercase tracking-wider rounded-md border border-emerald-200">POST</span>
                    <code className="text-sm font-bold text-slate-600 bg-[#f0f4f9] px-2 py-0.5 rounded">/v1/messages/send-location</code>
                  </div>
                </div>

                <div className="bg-[#1f1f1f] rounded-2xl overflow-hidden border border-[#333] shadow-md">
                  <pre className="p-5 text-xs md:text-sm font-mono text-[#ffcb6b] overflow-x-auto leading-loose">
{`{
  "sessionKey": "device-01",
  "to": "628123456789",
  "latitude": -6.200000,
          ...
          {activeTab === "sessions" && (
            <div className="space-y-8 animate-in slide-in-from-right-4 duration-300">
              ...
              <div className="flex items-center gap-3">
                ...
                <code className="text-sm font-bold text-slate-600 bg-[#f0f4f9] px-2 py-0.5 rounded">/v1/sessions</code>
              </div>
              ...
              <div className="bg-[#1f1f1f] rounded-2xl overflow-hidden border border-[#333] shadow-md mt-4">
                ...
                <pre className="p-5 text-xs md:text-sm font-mono text-[#c3e88d] overflow-x-auto leading-loose">
{`{
  "ok": true,
  "data": [
    {
      ...
      "phone_number": "62895412144456"
          ...
          {activeTab === "webhooks" && (
            <div className="space-y-8 animate-in slide-in-from-right-4 duration-300">
              ...
              <div className="p-6 md:p-8 rounded-3xl bg-[#001d35] text-white mt-8 shadow-sm">
                ...
                <div className="space-y-3">
                  <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-4">
                    <code className="text-xs bg-[#0b57d0] px-2 py-1 rounded text-white font-mono w-max sm:w-48 shrink-0">X-Webhook-Event</code>
                    <span className="text-xs text-slate-300">Tipe event (contoh: message.incoming)</span>
                  </div>
                  <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-4">
                    <code className="text-xs bg-[#0b57d0] px-2 py-1 rounded text-white font-mono w-max sm:w-48 shrink-0">X-Webhook-Delivery-Id</code>
                    <span className="text-xs text-slate-300">ID unik pengiriman (untuk mencegah duplikasi)</span>
                  </div>
                  <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-4">
                    <code className="text-xs bg-[#0b57d0] px-2 py-1 rounded text-white font-mono w-max sm:w-48 shrink-0">X-Webhook-Tenant</code>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-4 pt-2">
                    <code className="text-xs bg-rose-500/20 border border-rose-500/50 px-2 py-1 rounded text-rose-300 font-mono w-max sm:w-48 shrink-0">X-Webhook-Signature</code>
      ...
      {/* FOOTER CTA */}
      <div className="p-6 md:p-10 bg-[#f0f4f9] rounded-3xl border border-[#c2e7ff] flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <button className="px-8 py-3.5 bg-white text-[#0b57d0] border border-slate-200 rounded-full font-bold text-sm hover:bg-[#e9eef6] active:scale-95 transition-all shadow-sm shrink-0">
          Hubungi Engineer
        </button>
      </div>
