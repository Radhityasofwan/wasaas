...
function formatTime(dateStr: string) {
  if (!dateStr) return "";
  // Tambahkan 'Z' jika backend MySQL tidak memberikan timezone (mengamankan zona waktu UTC -> Lokal)
  const safeDateStr = dateStr.includes('T') && !dateStr.endsWith('Z') ? dateStr + 'Z' : dateStr;
...
function formatChatDate(dateStr: string, nowTime: Date) {
  ...
  const safeDateStr = dateStr.includes('T') && !dateStr.endsWith('Z') ? dateStr + 'Z' : dateStr;
  const d = new Date(safeDateStr);
  const diffDays = Math.floor((nowTime.getTime() - d.getTime()) / (1000 * 60 * 60 * 24));
  
  if (diffDays === 0 && nowTime.getDate() === d.getDate()) return formatTime(safeDateStr);
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex justify-between items-center mb-1">
                    ...
                    {/* WAKTU REALTIME - Menggunakan parameter liveTime agar ter-trigger per detik */}
