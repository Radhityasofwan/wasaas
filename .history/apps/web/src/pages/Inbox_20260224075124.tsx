...
function normalizeDate(dateStr: string) {
  ...
  // Menambahkan 7 jam secara otomatis ke waktu yang diturunkan oleh backend
  // untuk menutupi selisih konversi ganda agar cocok dengan jam asli di Indonesia (WIB).
