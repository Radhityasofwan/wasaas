...
export default function Leads() {
  ...
  const loadHelpers = async () => {
    try {
      ...
      // Hapus filter pada Leads Modal agar semua templates bisa dipilih!
        ...
        {isSelectionMode && selectedLeads.length > 0 && (
          <div className="absolute bottom-6 left-1/2 -translate-x-1/2 bg-slate-900 rounded-[2rem] p-4 shadow-2xl border border-slate-700 flex items-center gap-6 animate-in slide-in-from-bottom-10 z-50">
             ...
             <div className="flex gap-2">
                ...
                <button onClick={() => executeDeleteLeads(selectedLeads)} className="flex items-center gap-2 px-5 py-2 bg-rose-500 hover:bg-rose-600 rounded-xl text-white font-black text-[10px] uppercase tracking-widest transition-all">
