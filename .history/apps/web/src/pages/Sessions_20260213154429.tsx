          ...
          <tbody>
            {data.map((s) => (
              <tr key={s.id} style={{ borderTop: "1px solid #1f2c33" }}>
                <td style={td}><code>{s.session_key}</code></td>
                ...
                <td style={td}>
                  <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                    ...
                    <button onClick={() => stop(s.session_key)} style={{ ...btn, borderColor: "#5c1a1a" }}>Stop</button>
                  </div>
                </td>
              </tr>
            ))}
          ...
          <div style={modal} onClick={(e) => e.stopPropagation()}>
            ...
            <div style={{ marginTop: 12 }}>
              {qrDataUrl ? (
                ...
                <div style={{ opacity: 0.8 }}>QR belum tersedia / sudah connected.</div>
              )}
            </div>
...
const th: CSSProperties = { textAlign: "left", padding: 12, fontSize: 12, opacity: 0.9 };
const td: CSSProperties = { padding: 12, fontSize: 13 };
