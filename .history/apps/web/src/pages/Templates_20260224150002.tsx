...
export default function Templates() {
  ...
  // STATE & ENGINE UNTUK LIVE PREVIEW SPINTAX
              ...
              <div>
                ...
                <div className="mt-4 border border-slate-200 rounded-[1.5rem] bg-slate-50 overflow-hidden">
                  <div className="px-4 py-3 border-b border-slate-200 bg-slate-100/50 flex justify-between items-center">
                    ...
                    <button onClick={() => setPreviewTrigger(p => p + 1)} className="text-[9px] font-bold bg-white border border-slate-200 text-slate-600 px-2 py-1 rounded-md flex items-center gap-1 hover:text-blue-600 hover:border-blue-200 transition-colors shadow-sm">
